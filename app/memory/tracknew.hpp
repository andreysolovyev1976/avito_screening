...
/**
 * By Andrey Solovyev:
 * this thing doesn't work with g++ 11, obviously some problem with my local libc++
 * https://gcc.gnu.org/bugzilla/show_bug.cgi?id=83662
 *
 * it seems that my OS is also "... *ancient* ..." - see the comment 13 (link below)
 * https://gcc.gnu.org/bugzilla/show_bug.cgi?id=83662#c13
 * */
			p = std::malloc(size);
#else
